...
const HotelResults = ({ hotels, guestCount, checkIn = "", checkOut = "" }) => {
  ...
  return (
    <div className="mt-[20px]">
      ...
      <div className="flex min-[900px]:flex-row flex-col sm:items-start items-center justify-between gap-12">
        <div className="flex flex-col gap-[20px] basis-[calc(70%-24px)] sm:items-baseline items-center sm:w-auto w-[80%]">
        ...
        <div className="flex justify-center mb-12 basis-[calc(30%-24px)] min-[900px]:w-auto w-full">
          <iframe
            className="rounded-xl min-[900px]:h-[796px] h-[400px]"
